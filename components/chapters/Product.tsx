...
function HomeScreen() {
  return (
    <div style={{ height: "100%", background: "white" }}>
      ...
      <div style={{ margin: "0 10px", borderRadius: 10, background: "#F4EBD6", padding: "14px" }}>
      ...
      <div style={{ display: "flex", gap: 6, padding: "0 10px", overflowX: "hidden" }}>
        {[{ n: "Dish Soap", p: "£8.99", r: true, bg: "#F4EBD6" }, { n: "Towels", p: "£14.99", r: false, bg: "#E2F0EE" }, { n: "Laundry", p: "£11.99", r: true, bg: "#FAE5D3" }].map(item => (
          <div key={item.n} style={{ flexShrink: 0, width: 68, borderRadius: 6, border: "1px solid #F0EDE8", padding: 6 }}>
            <div style={{ height: 44, borderRadius: 5, background: item.bg, marginBottom: 5 }}/>
    ...
    <div style={{ height: "100%", background: "white" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6, padding: "0 10px" }}>
        {[{ n: "Dish Soap Refillable", p: "£8.99", r: true, bg: "#F4EBD6" }, { n: "Glass Spray Bottle", p: "£12.99", r: false, bg: "#E2F0EE" }, { n: "Laundry Sheets", p: "£11.99", r: true, bg: "#FAE5D3" }, { n: "Beeswax Wrap", p: "£9.99", r: false, bg: "#F4EBD6" }].map(item => (
          <div key={item.n} style={{ borderRadius: 6, border: "1px solid #F0EDE8", padding: 8 }}>
            <div style={{ height: 52, borderRadius: 5, background: item.bg, marginBottom: 6 }}/>
    ...
    <div style={{ height: "100%", background: "white" }}>
      ...
      <div style={{ padding: "12px 14px 0" }}>
        ...
        <div style={{ borderTop: "1px solid #F0EDE8", marginTop: 10, paddingTop: 10, display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div><p style={{ fontSize: 16, fontWeight: 700, color: "#1B2B4B" }}>£8.99</p><p style={{ fontSize: 8, color: "#8C9BAD" }}>One-time</p></div>
          <div style={{ textAlign: "right" }}><p style={{ fontSize: 14, fontWeight: 700, color: "#2A9D8F" }}>£8.09</p><p style={{ fontSize: 8, color: "#8C9BAD" }}>Every 30 days · save 10%</p></div>
        </div>
      </div>
      <BottomNav active="products"/>
    </div>
  ...
  return (
    <div style={{ height: "100%", background: "white" }}>
      ...
      <div style={{ margin: "0 10px", display: "flex", background: "#F8F6F2", borderRadius: 6, padding: 2 }}>
        <button style={{ flex: 1, borderRadius: 4, padding: "6px 0", fontSize: 9, color: "#8C9BAD", background: "transparent", border: "none" }}>One-time</button>
      ...
      <div style={{ margin: "10px 10px 0", borderRadius: 8, background: "#E2F0EE", padding: 12 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div><p style={{ fontSize: 18, fontWeight: 700, color: "#2A9D8F" }}>£8.09</p><p style={{ fontSize: 8, color: "#6B7A8A" }}>per delivery</p></div>
        ...
        <div style={{ borderTop: "1px solid rgba(42,157,143,0.2)", marginTop: 8, paddingTop: 8, display: "flex", justifyContent: "space-between" }}>
          <p style={{ fontSize: 9, color: "#6B7A8A" }}>Frequency</p><p style={{ fontSize: 9, fontWeight: 600, color: "#1B2B4B" }}>Every 30 days</p>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", marginTop: 4 }}>
          <p style={{ fontSize: 9, color: "#6B7A8A" }}>Annual saving</p><p style={{ fontSize: 9, fontWeight: 600, color: "#2A9D8F" }}>~£10.80</p>
        </div>
      </div>
    ...
    <div style={{ height: "100%", background: "white" }}>
      ...
      <div style={{ padding: "0 10px", display: "flex", flexDirection: "column", gap: 6 }}>
        {[{ n: "Dish Soap Refillable", p: "£8.09", r: true }, { n: "Bamboo Hand Towels", p: "£14.99", r: false }, { n: "Laundry Sheets ×2", p: "£23.98", r: true }].map(item => (
          <div key={item.n} style={{ display: "flex", gap: 8, borderRadius: 6, border: "1px solid #F0EDE8", padding: 8, alignItems: "center" }}>
            <div style={{ width: 36, height: 36, borderRadius: 5, background: "#F8F6F2", flexShrink: 0 }}/>
            <div style={{ flex: 1 }}>
      ...
      <div style={{ padding: "10px 14px 0", display: "flex", justifyContent: "space-between" }}>
        <span style={{ fontSize: 10, color: "#2A9D8F", fontWeight: 500 }}>Continue shopping</span>
  ...
  return (
    <div style={{ height: "100%", background: "white", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, padding: "10px 10px 0", display: "flex", flexDirection: "column", gap: 8 }}>
        <div style={{ background: "#F8F6F2", borderRadius: 6, padding: 10 }}>
          <p style={{ fontSize: 8, fontWeight: 500, color: "#8C9BAD", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 }}>Order</p>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 3 }}><p style={{ fontSize: 9, color: "#6B7A8A" }}>3 items</p><p style={{ fontSize: 9, fontWeight: 600, color: "#1B2B4B" }}>£47.06</p></div>
          <div style={{ display: "flex", justifyContent: "space-between" }}><p style={{ fontSize: 9, color: "#2A9D8F" }}>Repeat saving</p><p style={{ fontSize: 9, fontWeight: 600, color: "#2A9D8F" }}>−£2.12</p></div>
        ...
        <div style={{ borderRadius: 6, border: "1px solid #F0EDE8", padding: 10 }}>
  ...
  return (
    <div style={{ height: "100%", background: "white" }}>
      <div style={{ padding: "4px 10px 8px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#F8F6F2", borderRadius: 6, padding: "8px 12px" }}>
          ...
          <span style={{ fontSize: 10, color: "#8C9BAD" }}>Search products…</span>
        </div>
      </div>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6, padding: "0 10px" }}>
        {[{ n: "Dish Soap", bg: "#F4EBD6", p: "£8.09", r: true }, { n: "Laundry Sheets", bg: "#E2F0EE", p: "£11.99", r: true }, { n: "Glass Bottle", bg: "#FAE5D3", p: "£12.99", r: false }, { n: "Bamboo Towels", bg: "#F4EBD6", p: "£14.99", r: false }].map(item => (
          <div key={item.n} style={{ borderRadius: 6, border: "1px solid #F0EDE8", padding: 8 }}>
            <div style={{ height: 52, borderRadius: 5, background: item.bg, marginBottom: 6 }}/>
            <p style={{ fontSize: 8.5, fontWeight: 600, color: "#1B2B4B", lineHeight: 1.2, marginBottom: 3 }}>{item.n}</p>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
...
/* ── Decisions ── */
const DECISIONS = [
  { n: "01", label: "Search lives in Products, not the global bar", body: "Search is a browsing act, not a navigation act. Scoping it to Products aligns the entry point with the intent." },
  { n: "02", label: "Repeat only where it makes sense",            body: "One-time products never show Repeat messaging. Adding the mental model only when it applies reduces noise." },
  { n: "03", label: "Cart keeps 'Continue shopping' visible",      body: "Removing the exit from a cart puts pressure on users. Pare's audience is deliberate — giving them an off-ramp respects their pace." },
  { n: "04", label: "Four tabs, nothing hidden",                   body: "Home, Products, Bag, Profile. Every primary journey in one tap. No 'More', no orphaned screens." },
];
...
export default function Product() {
  ...
  return (
    <section id="product" style={{ background: "white" }}>
      ...
      <div style={{ borderTop: "1px solid var(--color-border)", padding: "48px 80px 0" }}>
        <SectionReveal>
          <div style={{ display: "flex", alignItems: "center", gap: 20, paddingBottom: 48, borderBottom: "1px solid var(--color-border)" }}>
            <span style={L("var(--color-teal)")}>02</span>
            <div style={{ flex: 1, height: 1, background: "var(--color-border)" }}/>
            <span style={L()}>Product</span>
          </div>
        </SectionReveal>
      </div>
      ...
      <div style={{ padding: "72px 80px 0" }}>
        <SectionReveal>
          <h2 style={{
            ...
            The app, as one<br/>connected flow.
          </h2>
        </SectionReveal>
        ...
        <SectionReveal delay={80}>
          <div style={{ marginTop: 48, display: "grid", gridTemplateColumns: "1fr 2fr", gap: "0 80px", borderTop: "1px solid var(--color-border)", paddingTop: 32 }}>
            <p style={L()}>What you're looking at</p>
            <p style={{ fontFamily: "var(--font-inter-var)", fontSize: 16, lineHeight: 1.75, color: "var(--color-subtle)", maxWidth: 560 }}>
              Every screen from the editorial home feed through to the order placed. No dead ends, no orphaned states. The entire purchase flow requires four navigation decisions and zero dead ends.
            </p>
          </div>
        </SectionReveal>
      </div>

      {/* ── Phone flow — edge to edge ── */}
      <SectionReveal delay={60} style={{ marginTop: 72 }}>
        <div style={{ borderTop: "1px solid var(--color-border)", borderBottom: "1px solid var(--color-border)", padding: "64px 80px", background: "#F8F6F3" }}>
      ...
      <div style={{ padding: "96px 80px 0" }}>
        <SectionReveal>
          <p style={{ ...L(), marginBottom: 48 }}>Key decisions</p>
        </SectionReveal>
        {DECISIONS.map((d, i) => (
          <SectionReveal key={d.n} delay={i * 70} from="bottom">
            <div style={{
              ...
              <p style={{ fontFamily: "var(--font-inter-var)", fontSize: 15, lineHeight: 1.75, color: "var(--color-subtle)" }}>{d.body}</p>
            </div>
          </SectionReveal>
        ))}
      </div>
